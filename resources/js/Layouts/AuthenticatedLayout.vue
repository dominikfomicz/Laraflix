			...
			<nav class="bg-white border-b border-gray-100">
					...
					<div class="flex justify-between h-16">
						<div class="flex">
							...
							<div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
								<NavLink :active="$page.url.startsWith('/movies')"
										 :href="route('movies.index')">
									Movies
								</NavLink>
								<NavLink :active="$page.url.startsWith('/persons')" :href="route('persons.index')">
									Persons
								</NavLink>
								<NavLink :active="$page.url.startsWith('/roles')" :href="route('roles.index')">
									Roles
								</NavLink>
							</div>
						</div>
				...
				<div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
					...
					<div class="pt-2 pb-3 space-y-1">
						<ResponsiveNavLink :active="route().current('movies.index')" :href="route('movies.index')">
							Movies
						</ResponsiveNavLink>
					</div>
